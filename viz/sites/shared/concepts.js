/** P30 Investor Brief — narrative data (Dept of Peace omitted). Routes: #/{id} */
window.P30_STORY = {
...
window.P30_CONCEPTS = [
  {
    ...
    demoLabel: 'Watch where the ops go — this is what the market pays today',
  ...
  },
  {
    ...
    demoLabel: 'Live proof — run once, then send this URL to your IC',
  ...
  },
  {
    ...
    demoLabel: 'Product demo — toggle Library vs BIOS',
  ...
  },
  {
    ...
    demoLabel: 'Rack model — plug in your assumptions',
  ...
  },
  {
    ...
    demoLabel: 'Interactive TAM — US · Global · Utah',
  ...
  },
  {
    ...
    demoLabel: 'Timeline — Stretch to P30',
...
window.P30_THESIS = {
  eyebrow: 'Infoton P30 · Interactive investor brief',
